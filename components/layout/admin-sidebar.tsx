...
import { LayoutDashboard, Building2, Bell, LogOut, Menu, ShieldCheck } from 'lucide-react';
  ...
  return (
    <aside className="flex h-screen w-64 flex-col border-r border-border/60 bg-background">
      ...
      >
        ...
        <div>
          <span className="text-lg font-black text-foreground tracking-tight leading-none">PropFlow</span>
      ...
      <Sheet open={open} onOpenChange={setOpen}>
        <SheetContent side="left" className="w-64 p-0 flex flex-col border-r border-border/60">
          ...
          >
            ...
            <div>
              <span className="text-lg font-black tracking-tight leading-none">PropFlow</span>
              <span className="ml-1.5 rounded-full bg-destructive px-1.5 py-0.5 text-[9px] font-bold text-destructive-foreground">
                ADMIN
              </span>
            </div>
