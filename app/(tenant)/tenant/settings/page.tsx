...
export default function TenantSettingsPage() {
  ...
  return (
    <div className="space-y-4">
      {/* ── Compact gradient page header (violet/fuchsia for tenant) ── */}
      <div className="relative overflow-hidden rounded-2xl bg-linear-to-r from-violet-600 via-purple-600 to-fuchsia-600 px-5 py-4 text-white shadow-md shadow-violet-500/20">
